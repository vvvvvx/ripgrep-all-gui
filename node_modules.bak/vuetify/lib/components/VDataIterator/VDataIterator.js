...
import { createGroupBy, makeDataTableGroupProps, provideGroupBy, useGroupedItems, useOpenAllGroups } from "../VDataTable/composables/group.js";
...
export const VDataIterator = genericComponent()({
  ...
  setup(props, {
    ...
    const {
      flatItems
    } = useGroupedItems(sortedItems, groupBy, openedGroups, false, isGroupOpen, groupKey);
