...
export declare const makeVAlertProps: <Defaults extends {
    ...
    iconSizes: unknown extends Defaults["iconSizes"] ? {
        type: PropType<[import("../VIconBtn/VIconBtn.js").VIconBtnSizes, number][]>;
        default: () => (string | number)[][];
    } : Omit<{
        type: PropType<[import("../VIconBtn/VIconBtn.js").VIconBtnSizes, number][]>;
        default: () => (string | number)[][];
    }, "default" | "type"> & {
        type: PropType<unknown extends Defaults["iconSizes"] ? [import("../VIconBtn/VIconBtn.js").VIconBtnSizes, number][] : [import("../VIconBtn/VIconBtn.js").VIconBtnSizes, number][] | Defaults["iconSizes"]>;
        default: unknown extends Defaults["iconSizes"] ? [import("../VIconBtn/VIconBtn.js").VIconBtnSizes, number][] : [import("../VIconBtn/VIconBtn.js").VIconBtnSizes, number][] | Defaults["iconSizes"];
    };
...
export declare const VAlert: {
    new (...args: any[]): import("vue").CreateComponentPublicInstanceWithMixins<{
        ...
        iconSizes: [import("../VIconBtn/VIconBtn.js").VIconBtnSizes, number][];
        closable: boolean;
        closeIcon: IconValue;
        closeLabel: string;
    ...
    iconSize: PropType<import("../VIconBtn/VIconBtn.js").VIconBtnSizes | number | string>;
    iconSizes: {
        type: PropType<[import("../VIconBtn/VIconBtn.js").VIconBtnSizes, number][]>;
        default: () => (string | number)[][];
    };
