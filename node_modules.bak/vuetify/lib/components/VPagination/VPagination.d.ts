...
export declare const makeVPaginationProps: <Defaults extends {
    ...
    start: unknown extends Defaults["start"] ? {
        ...
        type: PropType<unknown extends Defaults["start"] ? string | number : string | number | Defaults["start"]>;
    ...
    ariaLabel: unknown extends Defaults["ariaLabel"] ? {
        ...
        type: PropType<unknown extends Defaults["ariaLabel"] ? string : string | Defaults["ariaLabel"]>;
    ...
    pageAriaLabel: unknown extends Defaults["pageAriaLabel"] ? {
        ...
        type: PropType<unknown extends Defaults["pageAriaLabel"] ? string : string | Defaults["pageAriaLabel"]>;
    ...
    currentPageAriaLabel: unknown extends Defaults["currentPageAriaLabel"] ? {
        ...
        type: PropType<unknown extends Defaults["currentPageAriaLabel"] ? string : string | Defaults["currentPageAriaLabel"]>;
    ...
    firstAriaLabel: unknown extends Defaults["firstAriaLabel"] ? {
        ...
        type: PropType<unknown extends Defaults["firstAriaLabel"] ? string : string | Defaults["firstAriaLabel"]>;
    ...
    previousAriaLabel: unknown extends Defaults["previousAriaLabel"] ? {
        ...
        type: PropType<unknown extends Defaults["previousAriaLabel"] ? string : string | Defaults["previousAriaLabel"]>;
    ...
    nextAriaLabel: unknown extends Defaults["nextAriaLabel"] ? {
        ...
        type: PropType<unknown extends Defaults["nextAriaLabel"] ? string : string | Defaults["nextAriaLabel"]>;
    ...
    lastAriaLabel: unknown extends Defaults["lastAriaLabel"] ? {
        ...
        type: PropType<unknown extends Defaults["lastAriaLabel"] ? string : string | Defaults["lastAriaLabel"]>;
    ...
    ellipsis: unknown extends Defaults["ellipsis"] ? {
        ...
        type: PropType<unknown extends Defaults["ellipsis"] ? string : string | Defaults["ellipsis"]>;
        default: unknown extends Defaults["ellipsis"] ? string : string | Defaults["ellipsis"];
    };
    showFirstLastPage: unknown extends Defaults["showFirstLastPage"] ? {
        type: PropType<boolean | 'only-first'>;
        default: boolean;
    } : Omit<{
        type: PropType<boolean | 'only-first'>;
        default: boolean;
    }, "default" | "type"> & {
        type: PropType<unknown extends Defaults["showFirstLastPage"] ? "only-first" | boolean : "only-first" | boolean | Defaults["showFirstLastPage"]>;
