...
export declare const makeLocationStrategyProps: <Defaults extends {
    ...
    location: unknown extends Defaults["location"] ? PropType<Anchor | undefined> : {
        type: PropType<unknown extends Defaults["location"] ? Anchor | undefined : Defaults["location"] | Anchor | undefined>;
...
export declare function getStaticLocationClasses(location: Anchor | undefined): {
    [x: string]: boolean;
} | undefined;
declare function staticLocationStrategy(data: LocationStrategyData, props: StrategyProps, contentStyles: Ref<Record<string, string>>): {
    updateLocation: () => void;
};
