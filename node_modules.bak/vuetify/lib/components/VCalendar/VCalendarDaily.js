import { createElementVNode as _createElementVNode, mergeProps as _mergeProps, createVNode as _createVNode, normalizeClass as _normalizeClass, normalizeStyle as _normalizeStyle, withDirectives as _withDirectives } from "vue";
// Components
...
import { makeIntervalHighlightProps, useIntervalHighlight } from "./composables/intervalHighlight.js"; // Directives
  ...
  setup(props, {
    ...
    function genDays() {
      return base.days.value.map((day, index) => {
        ...
        }), [genDayIntervals(index), genDayBody(day)]);
      });
    }
    ...
    function genDayInterval(interval) {
      ...
      }, [highlight.genUnderlay(), slots.interval?.(base.getSlotScope(interval))]);
    }
