import { createElementVNode as _createElementVNode, mergeProps as _mergeProps, normalizeClass as _normalizeClass, normalizeStyle as _normalizeStyle, createVNode as _createVNode } from "vue";
// Components
import { VCalendarDaily } from "./VCalendarDaily.js"; // Composables
import { makeCalendarBaseProps } from "./composables/calendarBase.js";
import { makeCalendarWithIntervalsProps, useCalendarWithIntervals } from "./composables/calendarWithIntervals.js";
import { makeIntervalHighlightProps, useIntervalHighlight } from "./composables/intervalHighlight.js"; // Utilities
...
export const VCalendarCategory = defineComponent({
  ...
  setup(props, {
    ...
    function genDay(day, index, categoryIndex) {
      ...
      }), [genDayIntervals(index, category), genDayBody(day, category)]);
    }
    ...
    function genDayInterval(interval, category) {
      ...
      return _createElementVNode("div", {
        "key": interval.time,
        "class": _normalizeClass(['v-calendar-daily__day-interval', {
      ...
      }, [highlight.genUnderlay(), slots.interval?.(getCategoryScope(base.getSlotScope(interval), category))]);
    }
