...
export declare const makeVSparklineProps: <Defaults extends {
    ...
    animation: unknown extends Defaults["animation"] ? {
        type: PropType<boolean | import("./util/line.js").SparklineAnimationConfig>;
        default: boolean;
    } : Omit<{
        type: PropType<boolean | import("./util/line.js").SparklineAnimationConfig>;
        default: boolean;
    }, "default" | "type"> & {
        type: PropType<unknown extends Defaults["animation"] ? boolean | import("./util/line.js").SparklineAnimationConfig : boolean | import("./util/line.js").SparklineAnimationConfig | Defaults["animation"]>;
    ...
    labels: unknown extends Defaults["labels"] ? {
        type: PropType<(string | import("./util/line.js").SparklineItem)[]>;
        default: () => never[];
    } : Omit<{
        type: PropType<(string | import("./util/line.js").SparklineItem)[]>;
        default: () => never[];
    }, "default" | "type"> & {
        type: PropType<unknown extends Defaults["labels"] ? (string | import("./util/line.js").SparklineItem)[] : (string | import("./util/line.js").SparklineItem)[] | Defaults["labels"]>;
    ...
    tooltip: unknown extends Defaults["tooltip"] ? {
        type: PropType<boolean | import("./util/line.js").SparklineTooltipConfig>;
        default: boolean;
    } : Omit<{
        type: PropType<boolean | import("./util/line.js").SparklineTooltipConfig>;
        default: boolean;
    }, "default" | "type"> & {
        type: PropType<unknown extends Defaults["tooltip"] ? boolean | import("./util/line.js").SparklineTooltipConfig : boolean | import("./util/line.js").SparklineTooltipConfig | Defaults["tooltip"]>;
