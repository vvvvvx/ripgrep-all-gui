...
import { convertToUnit, genericComponent, noop, omit, propsFactory, refElement, useRender } from "../../util/index.js"; // Types
...
export const makeVSnackbarProps = propsFactory({
  ...
  }), ['persistent', 'noClickAnimation', 'offset', 'retainFocus', 'captureFocus', 'disableInitialFocus', 'location', 'scrim', 'scrollStrategy', 'stickToTarget', 'viewportMargin'])
}, 'VSnackbar');
  ...
  setup(props, {
    ...
    useRender(() => {
      const overlayProps = VOverlay.filterProps({
        ...
        locationStrategy: props.locationStrategy ?? noop
      });
      ...
      return _createVNode(VOverlay, _mergeProps({
        ...
        }, [slots.header?.()]), props.timer && Number(props.timeout) > 0 && !isHovering.value && _createElementVNode("div", {
          "key": "timer",
