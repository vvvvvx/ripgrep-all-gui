...
export declare const makeVDatePickerProps: <Defaults extends {
    ...
    noAutoNavigation: unknown extends Defaults["noAutoNavigation"] ? BooleanConstructor : {
        type: import("vue").PropType<unknown extends Defaults["noAutoNavigation"] ? boolean : boolean | Defaults["noAutoNavigation"]>;
        default: unknown extends Defaults["noAutoNavigation"] ? boolean : boolean | Defaults["noAutoNavigation"];
    };
    previewValue: unknown extends Defaults["previewValue"] ? import("vue").PropType<unknown> : {
        type: import("vue").PropType<unknown extends Defaults["previewValue"] ? unknown : unknown>;
...
export declare const VDatePicker: {
    ...
    previewValue: import("vue").PropType<unknown>;
