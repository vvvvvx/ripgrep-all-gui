...
export declare const makeVSwitchProps: <Defaults extends {
    ...
    indeterminateIcon: unknown extends Defaults["indeterminateIcon"] ? PropType<IconValue> : {
    ...
    valueComparator: unknown extends Defaults["valueComparator"] ? {
        type: PropType<import("../../util/index.js").ValueComparator>;
    ...
    trueValue: unknown extends Defaults["trueValue"] ? null : {
        type: PropType<unknown extends Defaults["trueValue"] ? any : any>;
        default: unknown extends Defaults["trueValue"] ? any : any;
    };
    falseValue: unknown extends Defaults["falseValue"] ? null : {
        type: PropType<unknown extends Defaults["falseValue"] ? any : any>;
    ...
    inset: unknown extends Defaults["inset"] ? {
        type: PropType<boolean | 'tonal' | 'material' | 'square'>;
        default: boolean;
    } : Omit<{
        type: PropType<boolean | 'tonal' | 'material' | 'square'>;
        default: boolean;
    }, "default" | "type"> & {
        type: PropType<unknown extends Defaults["inset"] ? "material" | "square" | "tonal" | boolean : "material" | "square" | "tonal" | boolean | Defaults["inset"]>;
        default: unknown extends Defaults["inset"] ? "material" | "square" | "tonal" | boolean : Defaults["inset"] | NonNullable<"material" | "square" | "tonal" | boolean>;
    };
...
export declare const VSwitch: {
    new (...args: any[]): import("vue").CreateComponentPublicInstanceWithMixins<{
        ...
        inset: "material" | "square" | "tonal" | boolean;
        flat: boolean;
    ...
    }, "$children" | "modelValue" | "update:modelValue" | "v-slot:append" | "v-slot:default" | "v-slot:details" | "v-slot:input" | "v-slot:label" | "v-slot:loader" | "v-slot:message" | "v-slot:prepend" | "v-slot:thumb" | "v-slot:track-false" | "v-slot:track-true" | "v-slots">, import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, {
        style: import("vue").StyleValue;
        focused: boolean;
        errorMessages: string | readonly string[] | null;
        maxErrors: string | number;
        ...
        thumb: (arg: {
            icon: IconValue | undefined;
        } & VSwitchSlot) => import("vue").VNode<import("vue").RendererNode, import("vue").RendererElement, {
            [key: string]: any;
        }>[];
        'track-false': (arg: VSwitchSlot) => import("vue").VNode<import("vue").RendererNode, import("vue").RendererElement, {
            [key: string]: any;
        }>[];
        'track-true': (arg: VSwitchSlot) => import("vue").VNode<import("vue").RendererNode, import("vue").RendererElement, {
            [key: string]: any;
        }>[];
    ...
    indeterminateIcon: PropType<IconValue>;
    ripple: {
        type: PropType<boolean | {
            class?: string;
            keys?: string[];
