...
// Components
import { makeVConfirmEditProps, VConfirmEdit } from "../VConfirmEdit/VConfirmEdit.js";
import { makeVDatePickerProps, VDatePicker } from "../VDatePicker/VDatePicker.js";
...
export const VDateInput = genericComponent()({
  ...
  setup(props, {
    ...
    function onBlur(e) {
      if (e.relatedTarget?.closest('[data-v-date]')) {
