...
// @ts-ignore
import type { useLink as _useLink, NavigationGuardReturn, RouteLocation, RouteLocationNormalizedLoaded, RouteLocationRaw, Router } from 'vue-router';
...
export declare function useBackButton(router: Router | undefined, cb: () => NavigationGuardReturn): void;
