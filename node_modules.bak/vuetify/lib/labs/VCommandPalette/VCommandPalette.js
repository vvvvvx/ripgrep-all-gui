...
import { convertToUnit, genericComponent, getActiveElement, omit, propsFactory, useRender } from "../../util/index.js"; // Types
  ...
  setup(props, {
    ...
    watch(isOpen, (newValue, oldValue) => {
      if (newValue && !oldValue) {
        previouslyFocusedElement.value = getActiveElement();
        searchQuery.value = '';
        navigation.reset();
