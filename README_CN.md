...
这是一款在海量硬盘上快速搜索文件内容的全文搜索软件，也可以用它搜文件名。可直接搜索zip内部文本而无需解压。可搜索的文件包括：**压缩文件、电子书、SQLite、docx、PDF、jpg、电影字幕，及其他任何文本文件**，甚至可搜索exe程序内部文本。

你无需知道文件位置或文件名，只需记得文件内的某个词或几个字，就可帮你找到它。
