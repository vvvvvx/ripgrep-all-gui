...
export declare const makeVOverlayProps: <Defaults extends {
    ...
    location: unknown extends Defaults["location"] ? PropType<import("../../util/index.js").Anchor | undefined> : {
...
export declare const VOverlay: {
    ...
    location: PropType<import("./locationStrategies.js").StrategyProps['location']>;
    origin: {
        type: PropType<import("./locationStrategies.js").StrategyProps['origin']>;
        default: string;
    };
