...
export declare const VRangeSlider: {
    new (...args: any[]): import("vue").CreateComponentPublicInstanceWithMixins<{
        ...
        $children?: {
            ...
            $stable?: boolean;
        } | ((arg: import("../VInput/VInput.js").VInputSlot) => import("vue").VNodeChild) | import("vue").VNodeChild;
        'v-slots'?: {
        ...
        label: (arg: import("../VInput/VInput.js").VInputSlot) => import("vue").VNode<import("vue").RendererNode, import("vue").RendererElement, {
            [key: string]: any;
        }>[];
