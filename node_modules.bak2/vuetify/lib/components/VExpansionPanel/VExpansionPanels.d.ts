...
export declare const makeVExpansionPanelsProps: <Defaults extends {
    ...
    noDivider: unknown extends Defaults["noDivider"] ? BooleanConstructor : {
        type: PropType<unknown extends Defaults["noDivider"] ? boolean : boolean | Defaults["noDivider"]>;
        default: unknown extends Defaults["noDivider"] ? boolean : boolean | Defaults["noDivider"];
    };
    rounded: unknown extends Defaults["rounded"] ? PropType<string | number | boolean | (string | number)[]> : {
        type: PropType<unknown extends Defaults["rounded"] ? string | number | boolean | (string | number)[] : string | number | boolean | (string | number)[] | Defaults["rounded"]>;
...
export declare const VExpansionPanels: {
    ...
    rounded: PropType<boolean | number | string | (number | string)[]>;
    variant: {
        type: PropType<Variant>;
        default: string;
        validator: (v: any) => boolean;
