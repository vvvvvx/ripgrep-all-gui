...
import { animate, convertToUnit, EventProp, genericComponent, getActiveElement, nullifyTransforms, PREFERS_REDUCED_MOTION, propsFactory, standardEasing, useRender } from "../../util/index.js";
  ...
  setup(props, {
    ...
    useRender(() => {
      ...
      return _createElementVNode("div", _mergeProps({
        ...
        "style": [backgroundColorStyles.value, roundedStyles.value, props.style],
        "onClick": onClick
