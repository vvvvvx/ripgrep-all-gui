...
export declare const VDataTableVirtual: {
    new (...args: any[]): import("vue").CreateComponentPublicInstanceWithMixins<{
    ...
    }, "$children" | "cellProps" | "headers" | "itemSelectable" | "itemValue" | "items" | "modelValue" | "rowProps" | "update:modelValue" | "v-slot:body.append" | "v-slot:body.prepend" | "v-slot:bottom" | "v-slot:caption" | "v-slot:colgroup" | "v-slot:data-table-group" | "v-slot:data-table-select" | "v-slot:expanded" | "v-slot:expanded-row" | "v-slot:group-header" | "v-slot:group-summary" | "v-slot:headers" | "v-slot:item" | "v-slot:loader" | "v-slot:loading" | "v-slot:mobile.header" | "v-slot:no-data" | "v-slot:tbody" | "v-slot:tfoot" | "v-slot:thead" | "v-slot:top" | "v-slots" | `v-slot:header.${string}` | `v-slot:item.${string}`>, import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, {
        ...
        [x: `item.${string}`]: (arg: import("./types.js").ItemKeySlot<any>) => VNode[];
        [x: `header.${string}`]: (arg: import("./VDataTableHeaders.js").VDataTableHeaderCellColumnSlotProps) => VNode[];
        headers: (arg: import("./VDataTableHeaders.js").HeadersSlotProps) => VNode[];
        loader: (arg: import("../../composables/loader.js").LoaderSlotProps) => VNode[];
        'mobile.header': (arg: import("./VDataTableHeaders.js").HeadersSlotProps) => VNode[];
        ...
        'item.data-table-select': (arg: import("./VDataTableRow.js").VDataTableItemCellColumnSlotProps<any>) => VNode[];
        'item.data-table-expand': (arg: import("./VDataTableRow.js").VDataTableItemCellColumnSlotProps<any>) => VNode[];
        'header.data-table-select': (arg: import("./VDataTableHeaders.js").VDataTableHeaderCellColumnSlotProps) => VNode[];
        'header.data-table-expand': (arg: import("./VDataTableHeaders.js").VDataTableHeaderCellColumnSlotProps) => VNode[];
        item: (arg: {
            index: number;
            item: any;
        ...
        loading: () => VNode[];
        'group-header': (arg: import("./types.js").GroupHeaderSlot) => VNode[];
        'group-summary': (arg: import("./types.js").GroupSummarySlot) => VNode[];
        'no-data': () => VNode[];
        'expanded-row': (arg: import("./types.js").ItemSlot<any>) => VNode[];
        expanded: (arg: import("./types.js").ItemSlot<any>) => VNode[];
        caption: () => VNode[];
        colgroup: (arg: VDataTableVirtualSlotProps<any>) => VNode[];
        top: (arg: VDataTableVirtualSlotProps<any>) => VNode[];
        tbody: (arg: VDataTableVirtualSlotProps<any>) => VNode[];
        thead: (arg: VDataTableVirtualSlotProps<any>) => VNode[];
        tfoot: (arg: VDataTableVirtualSlotProps<any>) => VNode[];
        bottom: (arg: VDataTableVirtualSlotProps<any>) => VNode[];
        'body.prepend': (arg: VDataTableVirtualSlotProps<any>) => VNode[];
        'body.append': (arg: VDataTableVirtualSlotProps<any>) => VNode[];
    }>>, import("vue").GlobalComponents, import("vue").GlobalDirectives, string, {}, any, import("vue").ComponentProvideOptions, {
        P: {};
        B: {};
        D: {};
