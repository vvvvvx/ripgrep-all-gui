...
export declare const makeVDataTableGroupHeaderRowProps: <Defaults extends {
    ...
    selectGroupLabel: unknown extends Defaults["selectGroupLabel"] ? {
        ...
        type: PropType<unknown extends Defaults["selectGroupLabel"] ? string : string | Defaults["selectGroupLabel"]>;
        default: unknown extends Defaults["selectGroupLabel"] ? string : string | Defaults["selectGroupLabel"];
    };
};
