...
export declare const makeDataTableProps: <Defaults extends {
    ...
    getMatches: unknown extends Defaults["getMatches"] ? import("vue").PropType<(item: DataTableItem) => Record<string, import("../../composables/filter.js").FilterMatchArrayMultiple | undefined> | undefined> : {
        type: import("vue").PropType<unknown extends Defaults["getMatches"] ? (item: DataTableItem) => Record<string, import("../../composables/filter.js").FilterMatchArrayMultiple | undefined> | undefined : ((item: DataTableItem) => Record<string, import("../../composables/filter.js").FilterMatchArrayMultiple | undefined> | undefined) | Defaults["getMatches"]>;
...
export declare const VDataTable: {
    ...
    getMatches: import("vue").PropType<(item: DataTableItem) => Record<string, import("../../composables/filter.js").FilterMatchArrayMultiple | undefined> | undefined>;
    loadingText: {
        type: StringConstructor;
        default: string;
    };
