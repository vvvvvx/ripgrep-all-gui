...
export declare const makeVDataTableRowProps: <Defaults extends {
    ...
    selectRowLabel: unknown extends Defaults["selectRowLabel"] ? {
        ...
        type: PropType<unknown extends Defaults["selectRowLabel"] ? string : string | Defaults["selectRowLabel"]>;
        default: unknown extends Defaults["selectRowLabel"] ? string : string | Defaults["selectRowLabel"];
    };
    getMatches: unknown extends Defaults["getMatches"] ? PropType<(item: DataTableItem) => Record<string, FilterMatchArrayMultiple | undefined> | undefined> : {
        type: PropType<unknown extends Defaults["getMatches"] ? (item: DataTableItem) => Record<string, FilterMatchArrayMultiple | undefined> | undefined : ((item: DataTableItem) => Record<string, FilterMatchArrayMultiple | undefined> | undefined) | Defaults["getMatches"]>;
        default: unknown extends Defaults["getMatches"] ? (item: DataTableItem) => Record<string, FilterMatchArrayMultiple | undefined> | undefined : ((item: DataTableItem) => Record<string, FilterMatchArrayMultiple | undefined> | undefined) | Defaults["getMatches"];
    };
...
export declare const VDataTableRow: {
    new (...args: any[]): import("vue").CreateComponentPublicInstanceWithMixins<{
        ...
        getMatches?: ((item: DataTableItem) => Record<string, FilterMatchArrayMultiple | undefined> | undefined) | undefined;
    ...
    getMatches: PropType<(item: DataTableItem) => Record<string, FilterMatchArrayMultiple | undefined> | undefined>;
