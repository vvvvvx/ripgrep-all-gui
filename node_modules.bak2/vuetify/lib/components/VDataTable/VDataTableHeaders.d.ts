...
export declare const makeVDataTableHeadersProps: <Defaults extends {
    ...
    selectAllLabel: unknown extends Defaults["selectAllLabel"] ? {
        ...
        type: PropType<unknown extends Defaults["selectAllLabel"] ? string : string | Defaults["selectAllLabel"]>;
...
export declare const VDataTableHeaders: {
    new (...args: any[]): import("vue").CreateComponentPublicInstanceWithMixins<{
        ...
        $children?: {
            ...
            'mobile.header'?: ((arg: HeadersSlotProps) => import("vue").VNodeChild) | undefined;
        } | {
            $stable?: boolean;
        ...
        'v-slots'?: {
            ...
            'mobile.header'?: false | ((arg: HeadersSlotProps) => import("vue").VNodeChild) | undefined;
        } | undefined;
    } & {
        ...
        "v-slot:mobile.header"?: false | ((arg: HeadersSlotProps) => import("vue").VNodeChild) | undefined;
        ...
        'mobile.header': (arg: HeadersSlotProps) => import("vue").VNode<import("vue").RendererNode, import("vue").RendererElement, {
            [key: string]: any;
        }>[];
