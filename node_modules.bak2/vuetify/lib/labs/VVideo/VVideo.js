...
import { VIconBtn } from "../../components/VIconBtn/VIconBtn.js";
import { VImg } from "../../components/VImg/VImg.js";
import { VProgressCircular } from "../../components/VProgressCircular/VProgressCircular.js"; // Composables
...
export const VVideo = genericComponent()({
  ...
  setup(props, {
    ...
    const {
      ...
      roundedStyles: roundedContainerStyles
    } = useRounded(roundedForContainer);
    const {
      roundedClasses: roundedControlsClasses,
      roundedStyles: roundedControlsStyles
    ...
    useRender(() => {
      ...
      return _createElementVNode("div", {
        ...
        }, props.variant === 'background' ? [] : pick(dimensionStyles.value, ['width', 'minWidth', 'maxWidth']), roundedContainerStyles.value, props.style]),
        "onKeydown": onKeydown,
        "onClick": onClick
